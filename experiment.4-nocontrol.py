...
def assign_offers_to_subpopulation(population, subpopulation, deliveries_file_name, deliveries_log_file_name, control_fraction=0, delimiter='|', clean_path=True):
...
def main(args):
    ...
    sample_size_per_week = int(len(population.people) / 1.0)
